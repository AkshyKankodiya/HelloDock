...
test.describe.serial('HelloDock', () => {
    ...
    test('Testcase_01Single_Document_Multi_PO_upload ', async ({page, reusableActionsClass_page }) => {
        ...
        await allure.step("Step_004_Global_Search", async () => {
            await reusableActionsClass_page.globalSearch(po_no.PO1.PO_Number);
        });

        await allure.step("Step_005_Verify_Extracted_Data_From_Field", async () => {
